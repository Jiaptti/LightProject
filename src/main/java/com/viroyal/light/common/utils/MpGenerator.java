...
//        gc.setOutputDir("F://temp//");
//        gc.setFileOverride(true);
//        gc.setActiveRecord(true);
//        gc.setEnableCache(false);// XML 二级缓存
//        gc.setBaseResultMap(true);// XML ResultMap
//        gc.setBaseColumnList(false);// XML columList
//        gc.setAuthor("jiaptti");
//
...
////        strategy.setTablePrefix(new String[] { "light_log_", "light_sys_" });// 此处可以修改为您的表前缀
...
//        pc.setParent("com.viroyal.light");
//        pc.setModuleName("module.light");
//        pc.setXml("dao");
